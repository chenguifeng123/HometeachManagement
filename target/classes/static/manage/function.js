...
(function(global){
    ...
    Date.prototype.format = function(formatString){
        ...
        return formatString.replace(new RegExp("[Yy]{4}","gi"), date.getFullYear()).
            replace(new RegExp("[Mm]{2}","gi"), new String(date.getMonth() + 1).padLeft(2,"0")).
            replace(new RegExp("[Dd]{2}","gi"), new String(date.getDate()).padLeft(2,"0")).
            replace(new RegExp("[Hh]{2}","gi"), new String(date.getHours()).padLeft(2,"0")).
            replace(new RegExp("[Mm][Ss]","gi"), new String(date.getMinutes()).padLeft(2,"0")).
            replace(new RegExp("[Ss]{2}","gi"), new String(date.getSeconds()).padLeft(2,"0"));
    }
